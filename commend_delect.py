...
def price_finder(address, item_name):
    ...
    if result == [None]:
        result = "This is not a possible input"
        return result
...
def compare(noOfS, item_name, store):
    ...
    if count == '0':
        ...
        if len(result_no) == 1:
            ...
            print(f'The lowest pric111111111111e of {item} amoung Store 1, Store 2 and Store 3 is {result_price} in Store{result_no}')
            return f'The lowest price of {item} amoung Store 1, Store 2 and Store 3 is {result_price} in Store{result_no}'
        ...
        if len(result_no) == 1:
            ...
            return f'The lowest price of {item} amoung those Store is ${result_price} in Store{result_no}'